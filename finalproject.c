...
volatile int thresh1 = 150;               //left sensor threshold -was 500
volatile int thresh2 = 900;               //center sensor threshold
volatile int thresh3 = 100;               //right sensor threshold - was 800
...
//                }
            ...
            case 1:
                ...
                LATBbits.LATB11=0;
                checkSensors();
                while ((leftGood==1)&&(centerGood==1)&&(rightGood==1)){
                    checkSensors();
                }
                state=2;
                break;
...
//                    LCDMoveCursor(1,0);
//                    LCDPrintString("LB CB RG"); // printed this
                    state = 3;
                }
...
//                    LCDMoveCursor(1,0);
//                    LCDPrintString("LB CG RG"); // printed this
                    state = 6;
                }
                else if ((leftGood==1)&&(centerGood==0)&&(rightGood==0)) { //veer right
//                    LCDMoveCursor(1,0);
//                    LCDPrintString("LG CB RB"); // printed this
                    state = 4;
                }
...
//                    LCDMoveCursor(1,0);
//                    LCDPrintString("LG CG RB"); // printed this
                    state = 5;
                }
                else if ((leftGood==1)&&(centerGood==1)&&(rightGood==1)) {  //should not get here
//                    LCDMoveCursor(1,0);
//                    LCDPrintString("LG CG RG"); // printed this
                    state = 1;
                }
